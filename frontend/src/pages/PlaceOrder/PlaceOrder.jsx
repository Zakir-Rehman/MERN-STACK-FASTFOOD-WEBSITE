...
import { ActivityIndicator } from "../../../../admin/src/components/Loaders/ActivityIndicator";

const PlaceOrder = () => {
  const { getTotalCartAmount, token, cartItems, food_list, clearCart } = useContext(StoreContext);
      ...
      <div className="place-order-right">
        <div className="cart-total">
          ...
          <button className="submit" type="submit">
            {placeOrderLoader ? <ActivityIndicator color="#FF4C24" borderColor="#fff" /> : "PLACE ORDER"}
          </button>
        </div>
      </div>
    </form>
